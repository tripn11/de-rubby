    ...
    return (
        <div id="faq">
            ...
            <section>
                ...
                <div className={point===0?"active":""} onClick={()=>setPoint(0)}>
                ...
                <div className={point===1?"active":""} onClick={()=>setPoint(1)}>
                ...
                <div className={point===2?"active":""} onClick={()=>setPoint(2)}>
                ...
                <div className={point===3?"active":""} onClick={()=>setPoint(3)}>
                ...
                <div className={point===4?"active":""} onClick={()=>setPoint(4)}>
                ...
                <div className={point===5?"active":""} onClick={()=>setPoint(5)}>
                ...
                <div className={point===6?"active":""} onClick={()=>setPoint(6)}>
